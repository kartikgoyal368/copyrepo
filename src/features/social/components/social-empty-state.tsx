...
export default function SocialEmptyState({
  title = "No CSR logs found",
  description = "Get started by scheduling your first CSR activity or recording employee volunteer logs.",
  onAction,
}: {
  title?: string;
  description?: string;
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 border border-dashed border-neutral-200 dark:border-neutral-800 rounded-xl min-h-[250px] bg-white/40 dark:bg-neutral-900/10 animate-in fade-in">
